...
class ModeTool:
    ...
    def select_circular(
        ...
        target_minutes: 사용자가 "OO분", "OO시간"처럼 시간으로만 말한 경우 그 숫자를 그대로
        채웁니다(직접 km로 계산하지 마세요). target_km을 이미 말했다면 target_minutes는 비워둡니다.
        km 환산은 이 도구가 아니라 호출한 쪽(Extractor)이 담당합니다.
        """
