...
class CommercialCollector:
    """상권 위치를 H3 셀별로 집계해 제한된 편의 점수를 생성합니다."""
    ...
    def save(self) -> None:
        ...
        h3_counts = CommercialRepository.get_unique_h3_counts()
        CollectorUtils.update_edge_scores("convenience_score", h3_counts)
        logger.info("상권 편의 점수 H3 셀 %d개 반영", len(h3_counts))
