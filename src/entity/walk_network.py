...
class WalkEdge(Base):
    ...
    safety_score: Mapped[float] = mapped_column(Float, server_default="0.0")
    nature_score: Mapped[float] = mapped_column(Float, server_default="0.0")
    slope_score: Mapped[float] = mapped_column(Float, server_default="0.0")
    landmark_score: Mapped[float] = mapped_column(Float, server_default="0.0")
