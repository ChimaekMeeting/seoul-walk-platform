...
def bind_nature_features(graph: Any, context: dict[str, Any] | None = None) -> Any:
    """
    Graph edge에 자연 관련 feature를 표준 이름으로 바인딩한다.

    담당:
    - 공원 접근성 (park_accessibility)
    - 하천 접근성 (river_accessibility)
    - 숲/나무 밀도 등
    ...
    출력:
    - 자연 feature가 edge attribute에 추가된 graph
    ...
    TODO:
    - 팀원이 기존 nature 관련 로직을 분석한 뒤 이 함수 내부를 채운다.
    """
    pass
