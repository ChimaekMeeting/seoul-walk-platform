...
| WeightExtractor LLM·파싱 실패 | 직전 턴 `feature_labels`를 그대로 유지(재추출 없이 진행, 대화는 계속됨) — 2026-09-20부터 호출이 성공해도 이번 턴에 언급 안 된 축은 병합으로 그대로 유지됨(§9 "2026-09-20" 참고) | 다음 intent에서 재시도 |
